...
export const cartCardRender = (item, index) => {
    ...
    cartCard.innerHTML = `  <div class="cart-remove-btn" id="removeCartItem${item.product._id}">&times</div>
                            ...
                            <div class="cart-product-info">
                                ...
                                <div class="cart-product-material">${item.product.description}</div>
                               
                                <div class="cart-product-price">${item.product.assignedEmployee}</div>
                            </div>
...
{/* <div class="cart-product-volume">${item.product.priority} ml</div>
<div class="cart-product-volume">${item.product.dueDate} ml</div> */}
...
const removeCartItem = async (item, index) =>  {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            msg.innerHTML = `Are you sure you want to remove task <b>${item.product.name}</b> from the cart? </br>`
            confirmModal.open();
