...
export const navbarRender = (user) => {
    ...
    navbarContainer.innerHTML = `
        <div class="site-name" id="navbarSiteName">
            <div class="shop-name site-name-item">DEVIN</div>
            <div class="fa fa-wrench site-name-item"></div>
        </div>
            ...
            navbarMenu.innerHTML = `<nav class="navbar navbar-light navbar-expand-md navbar-bg-body">
                                <div class="container">
                                    ...
                                    <div class="collapse navbar-collapse" id="n_bar">
                                        <ul class="navbar-nav">
                                            <li class="nav-item"><a class="nav-link" href="#" id="navbarProducts">TASKS</a></li>
