    ...
    try {
        productForm.parse(req, async (err, fields, files) => {
            try {
                ...
                const { productId, productCategory, productName, productDescription, productPriority, productDueDate, productAssignedEmployee,oldCloudinaryPublicId, oldImagePath } = fields;
                ...
                const productData = {
                    ...
                    assignedEmployee:productAssignedEmployee
                };
...
export const getAllProducts = async (req, res) => {
    ...
    switch (true) {
        ...
        case req.query.sort === 'decPr' :
            sortObj.priority = -1;
            break;
        case req.query.sort === 'incD' :
            sortObj.dueDate = 1;
            break;
        case req.query.sort === 'decD' :
            sortObj.dueDate = -1;
            break;
